...
#define STRING_CONFIG_H_AUTHOR "(Malekulo)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Activated charcoal" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "ourgarrus.ru"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Prosto Printer"
